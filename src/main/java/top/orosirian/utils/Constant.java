...
public class Constant {
    ...
    public static final String TOOL_PROMPT_TEMPLATE_MAC = """
            ...
            **资源工具使用**
            ...
            - 如果执行过程中报错了，请输出
            - 对于音乐获取，直接输出url作为超链接即可，对于小说获取，先获取书名+url，再将书名+url传递给工具下载下来，最后给用户输出超链接
            - 我正在调试这个应用，如果获取小说出现错误（未找到），请告诉我你得到的Response是否为空，你不能只说抱歉未找到，因为我搜索的书是存在的，只不过程序中存在错误，我正在调试错误，你说未找到对调试没有帮助
            """;
